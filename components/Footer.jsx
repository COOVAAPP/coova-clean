      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 border-t pt-6">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <p className="text-sm text-white">&copy; {year} COOVA. All rights reserved.</p>
            <div className="flex items-center gap-4 text-white">
              ...
              <a href="https://twitter.com" aria-label="X" className="hover:text-white">
              ...
              <a href="mailto:support@coova.app" aria-label="Email" className="hover:text-white">
