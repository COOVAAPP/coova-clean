      ...
      <div className="container-page py-10 grid grid-cols-1 sm:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex gap-4">
            <a href="https://instagram.com/yourhandle" target="_blank" rel="noopener noreferrer" className="hover:opacity-80">
              <span className="i-simple-icons-instagram h-6 w-6" />
            </a>
            <a href="https://twitter.com/yourhandle" target="_blank" rel="noopener noreferrer" className="hover:opacity-80">
              <span className="i-simple-icons-twitter h-6 w-6" />
            </a>
            <a href="https://tiktok.com/@yourhandle" target="_blank" rel="noopener noreferrer" className="hover:opacity-80">
