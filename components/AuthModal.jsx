...
import supabase from "../lib/supabaseClient"; // 👈 canonical client

/* ────────────────────────────────────────────────────────────────────────────
   Small helpers: scroll lock + focus trap
   ──────────────────────────────────────────────────────────────────────────── */
...
export default function AuthModal({
  ...
  }, [tab, email, pw, confirmPw, onClose]);
    ...
    >
      ...
      >
        ...
        <p className="mb-3 text-sm text-gray-500">
          {tab === "signin" ? "Sign in to continue." : "Sign up to start listing or booking spaces."}
        </p>
        ...
        <div className="mb-4 inline-flex rounded-md border border-gray-200 bg-gray-100 p-1 text-sm">
          <button
            ...
            className={`rounded px-3 py-1 ${tab === "signin" ? "bg-white shadow-sm" : "text-gray-600"}`}
          >
            Sign in
          </button>
          <button
            onClick={() => setTab("signup")}
            className={`rounded px-3 py-1 ${tab === "signup" ? "bg-white shadow-sm" : "text-gray-600"}`}
          >
            Sign up
          </button>
        </div>
          ...
          <div className="grid gap-3">
            ...
            <button
              ...
              className={`mt-1 inline-flex w-full items-center justify-center rounded-md px-4 py-2 text-sm font-semibold text-white transition ${
                canSubmit ? "bg-cyan-600 hover:bg-cyan-700" : "cursor-not-allowed bg-cyan-300"
              }`}
            >
        ...
        <div className="grid gap-2">
          ...
          >
            <svg viewBox="0 0 533.5 544.3" className="h-4 w-4" aria-hidden="true">
              <path fill="#4285f4" d="M533.5 278.4c0-18.6-1.5-37-4.6-54.8H272v103.8h147.1c-6.4 34.5-26.1 63.7-55.7 83.2v68h90.2c52.7-48.5 80.9-120.1 80.9-200.2z"/>
              <path fill="#34a853" d="M272 544.3c73.4 0 135.1-24.3 180.1-65.7l-90.2-68c-25 17-57.1 27-89.9 27-68.9 0-127.3-46.5-148.2-108.8h-93.4v68.7C75.6 485.8 167.8 544.3 272 544.3z"/>
              <path fill="#fbbc04" d="M123.8 328.8c-9.2-27.4-9.2-57 0-84.4v-68.7h-93.4C-15 231.1-15 313.2 30.4 372.9l93.4-68.7z"/>
              <path fill="#ea4335" d="M272 106c39.8-.6 78.3 14.2 107.7 41.8l80.5-80.5C408.7 22.6 339.6-.2 272 0 167.8 0 75.6 58.5 30.4 156.5l93.4 68.7C144.8 152.5 203.1 106 272 106z"/>
            </svg>
        ...
        <p className="mt-4 text-center text-[11px] text-gray-500">
          ...
          &{" "}
          <a href="/privacy" className="text-cyan-700 hover:underline">Privacy</a>.
        </p>
      </div>
    </div>
  );
