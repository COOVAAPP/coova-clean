...
export default function Header() {
  ...
  const navLinks = (
    <>
      <Link href="/browse" className="text-sm text-white font-bold hover:text-cyan-600">
        Browse
      </Link>
      <button onClick={onClickList} className="text-sm text-white font-bold hover:text-cyan-600">
        List your space
      </button>
    </>
  );
