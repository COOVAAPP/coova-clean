  ...
  return (
    <main className="min-h-screen flex flex-col gap-12">
      ...
      <RotatingHero
        ...
        // Optional: pass your own images; otherwise component uses its defaults
        images={[
      ...
      <section className="mx-auto max-w-6xl px-4 py-12">
        ...
        {/* Replace this grid with your existing cards/links */}
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 justify-items-center">
          {/* Example card — Pools & Venues */}
          <a
      ...
      <section className="bg-brand-600 py-12 text-cyan-50">
        ...
        <p className="mx-auto mt-2 max-w-2xl text-center text-cyan-50">
